...
public class TelaCadastroClientes extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        txtrg.setForeground(new java.awt.Color(0, 51, 102));
        ...
        txtnascimento.setForeground(new java.awt.Color(0, 51, 102));
        try {
        ...
        txtapelido.setForeground(new java.awt.Color(0, 51, 102));
        ...
        txtpai.setForeground(new java.awt.Color(0, 51, 102));

        txtmae.setForeground(new java.awt.Color(0, 51, 102));

        jLabel18.setText("Pai:");

        jLabel19.setText("Mãe:");

        txtconjugue.setForeground(new java.awt.Color(0, 51, 102));
        ...
        txtfone.setForeground(new java.awt.Color(0, 51, 102));

        jLabel16.setText("Fone:");

        jLabel17.setText("Celular:");

        txtcelular.setForeground(new java.awt.Color(0, 51, 102));
        try {
        ...
        txtlimite.setForeground(new java.awt.Color(0, 51, 102));
        ...
        txtreferencia.setForeground(new java.awt.Color(0, 51, 102));
