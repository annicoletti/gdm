...
import controller.CaixaDao;
import controller.CrediarioDao;
import controller.EstoqueDao;
import controller.LancamentoCartaoDAO;
...
public class TelaFinalizarVenda extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtopcsopgto.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "DINHEIRO", "CARTAO_DEBITO", "CARTAO_CREDITO", "CHEQUE", "CREDIARIO" }));
    ...
    private void btnfinalizeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnfinalizeActionPerformed
        ...
        if (controleFluxo == true) {
            ...
            if (valor < 0 && !txtopcsopgto.getSelectedItem().toString().equals("CREDIARIO")) {
                ...
                l.setCaixa(caixaDao.getCaixaPoCodigo(Long.parseLong(txtcaixan.getText().trim())));
